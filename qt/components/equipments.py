...
class EquipmentWidget(QWidget):
    def __init__(self, label):
        ...
        row_layout.addWidget(self.strength_level)
        ...
        for i in range(EMBED_POSITIONS[self.position]):
            ...
            row_layout.addWidget(embed_level)
