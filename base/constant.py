...
print(SHIELD_SCALE * (LEVEL_SCALE * 121 - LEVEL_CONSTANT))
...
DELTA_SCALE = 1
MAJOR_DELTA = 159 * DELTA_SCALE
PHYSICAL_DELTA = 318 * DELTA_SCALE
MAGICAL_DELTA = 380 * DELTA_SCALE
MINOR_DELTA = 710 * DELTA_SCALE
WEAPON_DELTA = 477 * DELTA_SCALE
...
def MAGICAL_ATTACK_POWER_COF(cof):
    return cof / DAMAGE_SCALE / MAGICAL_DAMAGE_SCALE


def MAGICAL_DOT_ATTACK_POWER_COF(cof, interval):
    return cof * interval / DOT_DAMAGE_SCALE / MAGICAL_DAMAGE_SCALE
