...
from schools.wen_shui_jue import (WenShuiJue, SKILLS, BUFFS, TALENTS, TALENT_GAINS, RECIPES, RECIPE_GAINS,
...
def main():
    ...
    attribute = WenShuiJue()
    attribute.agility_base += 10000
    attribute.surplus += 10000
    attribute.strain_base += 10000
    attribute.haste_base += 1300
