...
RECIPES = {
    ...
    "剑气长江": [
        "剑气长江(6%伤害)", "剑气长江(4%伤害)", "剑气长江(3%会心)", "剑气长江(2%会心)", "剑气长江(-1冷却)·1",
        "剑气长江(-1冷却)·2", "剑气长江(30%急曲)"
    ],
    "繁音急节": [
        "繁音急节(-3冷却)", "繁音急节(-2冷却)", "繁音急节(-1冷却)", "繁音急节(满堂)"
    ],
    "江海凝光": [
        "江海凝光(15%伤害)·1", "江海凝光(15%伤害)·2", "江海凝光(3%会心)", "江海凝光(2%会心)"
    ],
}
...
RECIPE_GAINS = {
    ...
    "剑气长江(-1冷却)·1": CDReductionRecipe(["剑气长江"], 16),
    "剑气长江(-1冷却)·2": CDReductionRecipe(["剑气长江"], 16),
    "剑气长江(30%急曲)": 剑气长江概率急曲(),
