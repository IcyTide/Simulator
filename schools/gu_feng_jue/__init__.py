...
loop = """
决云式,留客雨,行云式,行云式,留客雨,行云式,行云式,留客雨,断云式,识破(横云断浪:cd=0),横云断浪,沧浪三叠,沧浪三叠,沧浪三叠,孤锋破浪,
决云式,留客雨,行云式,行云式,留客雨,行云式,行云式,留客雨,断云式,沧浪三叠,沧浪三叠,沧浪三叠,孤锋破浪,
决云式,留客雨,行云式,行云式,留客雨,行云式,行云式,留客雨,断云式,横云断浪,沧浪三叠,沧浪三叠,游风飘踪(沧浪三叠:cd=0),识破,沧浪三叠,孤锋破浪
"""
