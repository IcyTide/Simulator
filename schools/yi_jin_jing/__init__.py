...
priority = """
罗汉金身,
擒龙诀(横扫六合:cd=0&禅那:stack<3),
千斤坠·无取(金刚日轮:stack=0|千斤坠·无取:duration<=1.5),
千斤坠·无舍(金刚日轮:stack=0|千斤坠·无舍:duration<=1.5),
千斤坠·无取(禅那:stack<3&金刚日轮:duration<=6),
千斤坠·无舍(禅那:stack<3&金刚日轮:duration<=6),
